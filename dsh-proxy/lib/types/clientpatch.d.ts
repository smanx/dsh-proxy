 ...
 */
export declare const LOOPBACK_TRUST_PATCHES: readonly ScriptPatch[];
/** Whether an HTTP response content-type names a JavaScript payload. */
export declare function isJavaScriptContentType(contentType: string): boolean;
/**
 ...
 */
export declare function patchClientScript(code: string): {
    code: string;
    matched: string[];
};
